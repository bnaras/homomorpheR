...
[`set_num_threads`](https://openfheorg.github.io/openfhe.R/reference/set_num_threads.html)`(``2L``)`
...
`  `[`encrypt`](https://bnaras.github.io/homomorpheR/reference/encrypt.md)`(``key``@``public``, `[`make_packed_plaintext`](https://openfheorg.github.io/openfhe.R/reference/make_packed_plaintext.html)`(``cc``, ``n``)``, cc ``=`` ``cc``)``)`\
\
`total`` ``<-`` `[`decrypt`](https://bnaras.github.io/homomorpheR/reference/decrypt.md)`(`[`Reduce`](https://rdrr.io/r/base/funprog.html)`(``` `+` ```, ``cts``)``, ``key``@``secret``, cc ``=`` ``cc``)`\
...
`    `[`encrypt`](https://bnaras.github.io/homomorpheR/reference/encrypt.md)`(``key``@``public``, `[`make_ckks_packed_plaintext`](https://openfheorg.github.io/openfhe.R/reference/make_ckks_packed_plaintext.html)`(``cc``, ``v``)``, cc ``=`` ``cc``)``)`\
\
...
`  ``}`\
\
`  ``res`` ``<-`` `[`decrypt`](https://bnaras.github.io/homomorpheR/reference/decrypt.md)`(``ct``, ``key``@``secret``, cc ``=`` ``cc``)`\
...
|:---|---:|---:|---:|:---|:---|
| sum | 1 | 1 | 50 | 1.47e-13 | 4.51e-14 |
| sum, wider scale | 1 | 1 | 59 | 8.88e-16 | 2.73e-16 |
| weighted sum (one multiply) | 1 | 2 | 50 | 1.72e-13 | 2.36e-13 |
| sum | 100 | 1 | 50 | 1.14e-13 | 3.46e-16 |
| sum, wider scale | 100 | 1 | 59 | 5.68e-14 | 1.73e-16 |
| weighted sum (one multiply) | 100 | 2 | 50 | 2.70e-13 | 3.82e-15 |
...
absolute error rises from 1.5e-13 at magnitude 1 to 7.3e-12 at magnitude
$`10^4`$, a factor of about 49, while the relative error *falls* — from
4.5e-14 to 2.2e-16. At magnitude 1 a fixed noise floor is large compared
...
magnitude 1 it improves the absolute error by a factor of 170. At
...
\
[`data`](https://rdrr.io/r/utils/data.html)`(``DLBCL``, package ``=`` ``"homomorpheR"``)`\
[`levels`](https://rdrr.io/r/base/levels.html)`(``DLBCL``$``Subgroup``)`
