...
## openfhe::CryptoContext + KeyPair.
##
## Skipped if openfhe is not installed (e.g., on a CRAN check
## environment without the C++ backend).

if (!requireNamespace("openfhe", quietly = TRUE)) exit_file("openfhe not installed")
...
## Encrypted-channel result agrees with the cleartext oracle.
