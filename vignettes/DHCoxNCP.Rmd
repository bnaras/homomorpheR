...
to the two non-cooperating parties P1 and P2. If the number of
participating sites in a computation changes, then both the master and
P1 and P2 have to be made aware of the change.

It would be simpler if only P1 and P2 can talk to both the master and
the sites.  Such a situation would arise, for example, when the sites
are all participating in a disease specific registry. The parties P1
and P2 would probably be set up once and any new site that has to be
...
be funneled to the sites through P1 and P2 and that can be easily
